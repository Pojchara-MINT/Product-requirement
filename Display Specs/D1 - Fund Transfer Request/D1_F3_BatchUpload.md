...
| เลขที่อ้างอิง | ✓ | M | — |
| ประเภทงาน | ✓ | M | ค่าที่รับได้: `เงินเกิน` / `ค่างวดรับล่วงหน้า` / `อื่น ๆ` เท่านั้น |
| หมายเหตุ | | O | — |
...
| ลำดับที่ | ช่องทาง | เลขพร้อมเพย์ | เลขที่บัญชี | bank code | ธนาคาร | ชื่อ-นามสกุล | ชื่อ-นามสกุล (ภาษาอังกฤษ) | จำนวนเงิน | เลขที่อ้างอิง | ประเภทงาน | หมายเหตุ | สมุดบัญชี/บัตรประชาชน | error message |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| ประเภทงาน ไม่อยู่ใน List ที่กำหนด | ประเภทงานต้องเป็น 'เงินเกิน', 'ค่างวดรับล่วงหน้า' หรือ 'อื่น ๆ' เท่านั้น |
