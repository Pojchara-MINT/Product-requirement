...
| สถานะงาน | เงื่อนไข |
|---------|---------|
| พร้อมตรวจ | ผลตรวจสอบบัญชีปลายทาง = ผ่าน **และ** ผลเงื่อนไขโอนเงิน = ผ่าน |
| ไม่พร้อมตรวจ | ผลตรวจสอบบัญชีปลายทาง = ยังไม่ได้รับผล **หรือ** ผลเงื่อนไขโอนเงิน = ยังไม่ได้รับผล (อย่างใดอย่างหนึ่ง) |
